...
#Code to find betweenness centrality, closeness centrality and assortativity coefficient of test match networks
from networkx import *
from networkx.algorithms import community
import sys
from networkx.algorithms.community import greedy_modularity_communities
# H for unweighted, G for weighted
H=nx.read_edgelist("Test_unweighted.txt")
G = nx.read_weighted_edgelist("Test_weighted.csv", comments='#', delimiter=',', create_using=None, nodetype=None,encoding='utf-8')
#print(G.nodes())
